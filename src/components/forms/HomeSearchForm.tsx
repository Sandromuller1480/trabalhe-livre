...
export default function HomeSearchForm() {
  ...
  return (
    <form 
      ...
      className="w-full max-w-2xl lg:max-w-[720px] bg-card-custom/90 backdrop-blur-md p-3 sm:p-3 rounded-2xl sm:rounded-[2rem] border-2 border-secondary-base/60 shadow-2xl flex flex-col sm:flex-row items-center gap-3 sm:gap-2 transition-all duration-300 hover:border-secondary-base/80 hover:shadow-primary-base/5"
    >
